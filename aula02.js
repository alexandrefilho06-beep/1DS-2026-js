...
let salarioTotal = salarioPessoa + salarioBonus;
...
' o status digitado foi: ' + statusPessoa +
' o salário digitado foi: ' + salarioPessoa +
' o bônus digitado foi: ' + salarioBonus +
